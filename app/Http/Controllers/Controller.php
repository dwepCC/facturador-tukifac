...
$string = var_export($header,true);
        ...
        /**
         *
         * Obtener cantidad minima de elementos a mostrar en busquedas (Select)
         *
         * @return int
         */
        public function getConfigMinItemsSelect()
        {
            return config('tenant.min_items_in_select') ?? 10;
        }


        /**
         *
         * Obtener cantidad maxima de elementos a mostrar en busquedas (Select)
         *
         * @return int
         */
