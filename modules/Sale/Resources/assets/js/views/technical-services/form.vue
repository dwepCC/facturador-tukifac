                    ...
                    <el-tab-pane class="mb-3" name="first">
                        ...
                        <div class="row">
                            ...
                            <div v-if="recordId" class="col-md-12">
                                <div
                                    :class="{ 'has-danger': errors.activities }"
                                    class="form-group"
                                >
                                    <label class="control-label"
                                        >Actividades realizadas (Equipo
                                        internado)</label
                                    >
                                    <el-input
                                            ...
                                            >
                                                ...
                                                <td>
                                                    ...
                                                    {{
                                                        ...
                                                        {{
                                                            getDescriptionFromAffectationIgvType(
            ...
            .then(response => {
                ...
                this.form.operation_type_id =
                    this.operation_types.length > 0
                        ...
                        : null;
                this.form.seller_id =
                    this.sellers.length > 0 ? this.idUser : null;
    ...
    methods: {
        ...
        discountGlobal() {
            ...
            if (this.form.discounts && this.form.discounts.length) {
                ...
                this.form.total_igv = _.round(
                    this.form.total_value * this.percentage_igv,
                    2
                );
                this.form.total_taxes = _.round(this.form.total_igv, 2);
                this.form.total = _.round(
        ...
        setDefaultDocumentType() {
            if (this.default_document_type === undefined)
                this.default_document_type = null;
            if (this.default_series_type === undefined)
                this.default_series_type = null;
