...
if ($hostname)
{
    Route::domain($hostname->fqdn)->group(function () {
        ...
        Route::middleware(['auth:api', 'locked.tenant'])->group(function () {
            ...
            Route::get('document-file/{model}/{external_id}/{format}', 'Api\DownloadController@returnFileData');
            ...
            Route::prefix('categories')->group(function () {
                Route::post('', 'Api\CategoryController@register');
            });
            ...
            Route::prefix('reports')->group(function () {
                ...
                Route::post('email', 'Api\ReportController@email');
            });
