...
if ($hostname) {
    Route::domain($hostname->fqdn)->group(function () {
        ...
        Route::middleware(['auth', 'redirect.module', 'locked.tenant','check.email.verified'])->group(function () {
            ...
            Route::post('certificates/save-due', 'Tenant\CertificateController@saveDueDate');
            ...
            // Perfil
            Route::get('profile', 'Tenant\ProfileController@index')->name('tenant.profile.index');
            Route::get('profile/record', 'Tenant\ProfileController@record'); 
