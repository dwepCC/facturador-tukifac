        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main pt-1" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <li class="{{ ($path[0] === 'clientes-metricas-central')?'nav-active':'' }}">
                        <a class="nav-link" href="{{ route('system.clients.central-metrics.index') }}">
            ...
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <li class="{{ ($path[0] === 'document-packages')?'nav-active':'' }}">
                        <a class="nav-link" href="{{route('system.document-packages.index')}}">
