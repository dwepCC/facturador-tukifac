<template>
    <div class="items">
        ...
        <div class="card tab-content-default row-new mb-0">
            ...
            <div class="card-body">
                <data-table ref="DataTable" :productType="type" :resource="resource" :sort-field="sortField" :sort-direction="sortDirection" :showProductFilter="type !== 'ZZ'" :min-search-length="3" @sort-change="handleSortChange" @records-changed="handleRecordsChanged">
