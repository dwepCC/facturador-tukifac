            ...
            <el-tabs v-model="activeName" class="mt-2">
                ...
                <el-tab-pane
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div v-if="form.item.currency_type_id !== undefined" :class="{'has-danger': errors.unit_price}"
                                 class="form-group">
...
export default {
    ...
    methods: {
        ...
        hasUnsavedChanges() {
          return this.form.item_id !== null || this.form.quantity !== 1 || this.form.unit_price > 0
        },
